...
export const NavBar = ()=> {
    ...
    useEffect(() => {
        ...
        //event listener for scrolling to dim navbar
        ...
        <div className = "container flex items-center justify-between">
                <a className="text-xl font-bold  flex items-center">
                    <span className="relative z-10">  
                       ...
                       Sterling <span className="text-primary"> Portfolio  </span> 
                    </span>
            ...
            <div className="hidden md:flex space-x-8">
                {navItems.map((item, key) => (
                    <a 
                        key={key} href={item.href} className={("text-foreground/80 hover:text-primary",
