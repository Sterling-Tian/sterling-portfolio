...
const skills =[
    ...
    {name: "Azure Data Factory", level: 95, category:"backend"},
    {name: "VS Code", level:95, category: "tool"},
    {name: "Azure Storage Explorer", level:90, category: "tool"}
]
const categories = ["all","frontend", "backend", "infrastructure", "tool"]
